...
static char *colors[][4] = {
    ...
    [SchemeInfoNorm] = {titlenormfgcolor, titlenormbgcolor,
                        titlenormbordercolor, titlenormfloatcolor},
    [SchemeInfoSel] = {titleselfgcolor, titleselbgcolor, titleselbordercolor,
                       titleselfloatcolor},
    ...
    [SchemeTagsSel] = {tagsselfgcolor, tagsselbgcolor, tagsselbordercolor,
                       tagsselfloatcolor},
    /* [SchemeHidNorm]      = { hidnormfgcolor,   hidnormbgcolor,   c000000,
       c000000 }, */
    /* [SchemeHidSel]       = { hidselfgcolor,    hidselbgcolor,    c000000,
       c000000 }, */
...
const char *spcmd2[] = {TERMINAL, "-n",    "spcalc", "-f", "monospace:size=9",
                        "-g",     "50x20", "-e",     "bc", "-lq",
                        NULL};
...
static Key keys[] = {
    ...
    /* { MODKEY|ShiftMask,		XK_apostrophe,	spawn,
       SHCMD("") }, */
    ...
    {0, XF86XK_MonBrightnessUp, spawn,
     SHCMD("export BRIGHTNESS=1.0 && brightness")},
    {0, XF86XK_MonBrightnessDown, spawn,
     SHCMD("export BRIGHTNESS=0.1 && brightness")},
